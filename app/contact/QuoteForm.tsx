...
export function QuoteForm() {
  ...
  const inputClass =
    "w-full rounded-md border border-border bg-black px-3 py-2.5 text-sm text-foreground placeholder:text-muted focus:border-gold focus:outline-none focus:ring-1 focus:ring-gold";
